...
CREATE INDEX IF NOT EXISTS idx_physical_sources_placement
    ON physical_sources(placement_host_name, placement_grpc_port);
...
CREATE INDEX IF NOT EXISTS idx_sinks_placement
    ON sinks(placement_host_name, placement_grpc_port);
...
CREATE INDEX IF NOT EXISTS idx_query_fragments_host
    ON query_fragments(host_name, grpc_port);

CREATE INDEX IF NOT EXISTS idx_query_fragments_query
    ON query_fragments(query_id);

CREATE INDEX IF NOT EXISTS idx_query_fragments_current_state
    ON query_fragments(current_state);

CREATE INDEX IF NOT EXISTS idx_query_fragments_desired_state
    ON query_fragments(desired_state);
